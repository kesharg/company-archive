...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('user_type',["admin","partner","partner_staff","distributor","distributor_staff","admin_staff"])->default("admin")->comment("Ex. admin/partner/distributor/staff etc");
